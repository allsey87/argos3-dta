#include "dta_srocs_loop_functions.h"
...
namespace argos {
   ...
   CDTASRoCSLoopFunctions::CDTASRoCSLoopFunctions() :
   ...
   void CDTASRoCSLoopFunctions::Init(TConfigurationNode& t_tree) {
   ...
   void CDTASRoCSLoopFunctions::PreStep() {
   ...
   REGISTER_LOOP_FUNCTIONS(CDTASRoCSLoopFunctions, "dta_srocs_loop_functions");
